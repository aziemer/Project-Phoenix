...
{ DmmDCVoltage,		5e-2,	0x11,	{0xC2,0x21,0x14,0x8B,0x35,0x11,0x08,0x15,0x31,0xF8,0x00,0x00,0x00,0x00,0x08,0x81,0x80,0xC7,0x3C,0xA8}, 125e-3 / 1.8 / 0x800000 },	// 0: 50 mV DC
{ DmmDCVoltage,		5e-1,	0x11,	{0xC2,0x21,0x14,0x8B,0x85,0x11,0x08,0x15,0x31,0xF8,0x00,0x00,0x00,0x00,0x08,0x81,0x80,0xC7,0x33,0xA8}, 125e-2 / 1.8 / 0x800000 },	// 1: 500 mV DC
{ DmmDCVoltage,		5e0,	0x31,	{0xC2,0x21,0x14,0x8B,0x01,0x11,0x08,0x15,0x31,0xF8,0x20,0x00,0x00,0x90,0x28,0xA0,0x80,0xC7,0x33,0xA8}, 125e-1 / 1.8 / 0x800000 },	// 2: 5 V DC
{ DmmDCVoltage,		5e1,	0x31,	{0xC2,0x21,0x14,0x8B,0x01,0x11,0x08,0x15,0x31,0xF8,0x20,0x00,0x00,0x09,0x28,0xA0,0x80,0xC7,0x33,0xA8}, 125e0  / 1.8 / 0x800000 },	// 3: 50 V DC
{ DmmDCVoltage,		5e2,	0x31,	{0xC2,0x21,0x14,0x8B,0x01,0x11,0x08,0x15,0x31,0xF8,0x20,0x00,0x90,0x00,0x28,0xA0,0x80,0xC7,0x33,0xA8}, 125e1  / 1.8 / 0x800000 },	// 4: 500 V DC
{ DmmDCVoltage,		1e3,	0x31,	{0xC2,0x21,0x14,0x8B,0x09,0x01,0x08,0x15,0x31,0xF8,0x20,0x00,0x90,0x00,0x28,0xA0,0x80,0xC7,0x33,0xA8}, 125e1  / 0.9 / 0x800000 },	// 5: 1kV DC

{ DmmACVoltage,		5e-1,	0x11,	{0xC2,0x21,0x00,0x00,0x45,0x00,0x88,0x15,0x31,0xF8,0x00,0x00,0x00,0x00,0x08,0x91,0x80,0xC7,0x3C,0xA0}, 1e-5 },						// 6: 500 mV AC
{ DmmACVoltage,		5e0,	0x31,	{0xC2,0x21,0x00,0x00,0x4D,0x00,0x88,0x15,0x31,0xF8,0x22,0x00,0x00,0xD0,0x88,0xA0,0xE9,0xC7,0x38,0x20}, 1e-4 },						// 7: 5 V AC
{ DmmACVoltage,		5e1,	0x31,	{0xC2,0x21,0x00,0x00,0x4D,0x00,0x88,0x15,0x31,0xF8,0x22,0x00,0x00,0x09,0x28,0xA0,0xFF,0xC7,0x38,0x20}, 1e-3 },						// 8: 50 V AC
{ DmmACVoltage,		5e2,	0x31,	{0xC2,0x21,0x00,0x00,0x4D,0x00,0x88,0x15,0x31,0xF8,0x22,0x00,0x90,0x00,0x28,0xA0,0x80,0xC7,0x38,0x20}, 1e-2 },						// 9: 500 V AC
{ DmmACVoltage,		1e3,	0x31,	{0xC2,0x21,0x00,0x00,0x4D,0x00,0x88,0x15,0x31,0xF8,0x22,0x00,0x90,0x00,0x28,0xA0,0x80,0xC7,0x38,0x20}, 1e-1 },						// 10:750 V AC

{ DmmDCCurrent,		5e-4,	0x30,	{0xC2,0x21,0x14,0x8B,0x35,0x11,0x08,0x15,0x11,0xF8,0x00,0x00,0x00,0x00,0x00,0xA0,0x80,0xC7,0x3D,0xAC}, 125e-5 / 1.8 / 0x800000 },	// 11: 500uA DC
{ DmmDCCurrent,		5e-3,	0x30,	{0xC2,0x21,0x14,0x8B,0x95,0x11,0x08,0x15,0x11,0xF8,0x00,0x00,0x00,0x00,0x00,0xA0,0x80,0xC7,0x33,0xAC}, 125e-4 / 1.8 / 0x800000 },	// 12: 5mA DC
{ DmmDCCurrent,		5e-2,	0x32,	{0xC2,0x21,0x14,0x8B,0x35,0x11,0x08,0x15,0x11,0xF8,0x00,0x00,0x00,0x00,0x00,0xA0,0x80,0xC7,0x3D,0xAC}, 125e-3 / 1.8 / 0x800000 },	// 13: 50mA DC
{ DmmDCCurrent,		5e-1,	0x32,	{0xC2,0x21,0x14,0x8B,0x95,0x11,0x08,0x15,0x11,0xF8,0x00,0x00,0x00,0x00,0x00,0xA0,0x80,0xC7,0x33,0xAC}, 125e-2 / 1.8 / 0x800000 },	// 14: 500mA DC
{ DmmDCCurrent,		5e0,	0x39,	{0xC2,0x21,0x14,0x8B,0x35,0x11,0x08,0x15,0x11,0xF8,0x00,0x00,0x00,0x00,0x00,0xA0,0x80,0xC7,0x3D,0xAC}, 125e-1 / 1.8 / 0x800000 },	// 15: 5 A DC
{ DmmDCCurrent,		10e0,	0x39,	{0xC2,0x21,0x14,0x8B,0x35,0x01,0x08,0x15,0x11,0xF8,0x00,0x00,0x00,0x00,0x00,0xA0,0x80,0xC7,0x3D,0xAC}, 125e-1 / 0.9 / 0x800000 },	// 16: 10 A DC

{ DmmACCurrent,		5e-4,	0x30,	{0xC2,0x21,0x12,0x00,0x45,0x01,0x88,0x15,0x31,0xF8,0x00,0x00,0x00,0x00,0x00,0xA0,0x80,0xC7,0x3D,0x20}, 1e-8 / 1.08 },				// 17: 500 uA AC
{ DmmACCurrent,		5e-3,	0x30,	{0xC2,0x21,0x12,0x00,0x45,0x00,0x88,0x15,0x31,0xF8,0x00,0x00,0x00,0x00,0x00,0xA0,0x80,0xC7,0x3D,0xA0}, 1e-7 / 2.16 },				// 18: 5 mA AC
{ DmmACCurrent,		5e-2,	0x32,	{0xC2,0x21,0x12,0x00,0x45,0x01,0x88,0x15,0x31,0xF8,0x00,0x00,0x00,0x00,0x00,0xA0,0x80,0xC7,0x3D,0x20}, 1e-6 / 1.08 },				// 19: 50 mA AC
{ DmmACCurrent,		5e-1,	0x32,	{0xC2,0x21,0x12,0x00,0x45,0x00,0x88,0x15,0x31,0xF8,0x00,0x00,0x00,0x00,0x00,0xA0,0x80,0xC7,0x3D,0xA0}, 1e-5 / 2.16 },				// 20: 500 mA AC
{ DmmACCurrent,		5e0,	0x39,	{0xC2,0x21,0x12,0x00,0x45,0x01,0x88,0x15,0x31,0xF8,0x00,0x00,0x00,0x00,0x00,0xA0,0x80,0xC7,0x3D,0x20}, 1e-4 / 1.08 },				// 21: 5 A AC
{ DmmACCurrent,		10e0,	0x39,	{0xC2,0x21,0x12,0x00,0x45,0x00,0x88,0x15,0x31,0xF8,0x00,0x00,0x00,0x00,0x00,0xA0,0x80,0xC7,0x3D,0xA0}, 1e-4 / 2.16 },				// 22: 10 A AC

//									{0xC0,0xCF,0x17,0x83,0x35,0x00,0x00,0x55,0x00,0x00,0x00,0x40,0x06,0x00,0x44,0x94,0x80,0xD2,0x3C,0xA0}, 1e3 / 0.9 / 0x800000 },		//     500 Ohm
//									{0xC0,0xCF,0x17,0x83,0x35,0x01,0x00,0x55,0x00,0x00,0x00,0x40,0x06,0x00,0x44,0x94,0x80,0xD2,0x3C,0xA0}, 1e2 / 0.9 / 0x800000 },		//     50 Ohm

{ DmmResistance,	5e2,	0x15,	{0xC2,0x21,0x14,0x83,0x85,0x01,0x08,0x15,0x00,0xF8,0x00,0x00,0x06,0x00,0x00,0x94,0x80,0xD2,0x3F,0xAC}, 1e3 / 0.9 / 0x800000 },		// 23: 500 Ohm
{ DmmResistance,	5e3,	0x15,	{0xC2,0x21,0x14,0x83,0x85,0x01,0x08,0x15,0x00,0xF8,0x00,0x00,0x60,0x00,0x00,0x94,0x80,0xD3,0x3F,0xAC}, 1e4 / 0.9 / 0x800000 },		// 24: 5 kOhm
{ DmmResistance,	5e4,	0x15,	{0xC2,0x21,0x14,0x83,0x85,0x01,0x08,0x15,0x00,0xF8,0x00,0x00,0x00,0x06,0x00,0x94,0x80,0xD3,0x3F,0xAC}, 1e5 / 0.9 / 0x800000 },		// 25: 50 kOhm
{ DmmResistance,	5e5,	0x15,	{0xC2,0x21,0x14,0x83,0x85,0x01,0x08,0x15,0x00,0xF8,0x00,0x00,0x00,0x60,0x00,0x94,0x80,0xD3,0x3F,0xAC}, 6e5 / 0.9 / 0x800000 },		// 26: 500 kOhm
{ DmmResistance,	5e6,	0x15,	{0xC2,0x21,0x14,0x93,0x85,0x01,0x08,0x15,0x55,0xF8,0x00,0x00,0x00,0x80,0x00,0x86,0x80,0xD1,0x3F,0xAC}, 6e6 / 0.9 / 0x800000 },		// 27: 5 MOhm
{ DmmResistance,	5e7,	0x15,	{0xC2,0x21,0x14,0x93,0x85,0x01,0x08,0x15,0x55,0xF8,0x00,0x08,0x00,0x00,0x00,0x86,0x80,0xD1,0x3F,0xAC}, 6e7 / 0.9 / 0x800000 },		// 28: 50 MOhm

{ DmmResistance4W,	5e2,	0x15,	{0xC2,0x21,0x14,0x83,0xA7,0x01,0x08,0x15,0x00,0xF8,0x00,0x00,0x06,0x00,0x00,0x94,0x80,0xD2,0x3F,0xAC}, 1e3 / 0.9 / 0x800000 },		// 29: 500 Ohm
{ DmmResistance4W,	5e3,	0x15,	{0xC2,0x21,0x14,0x83,0xA7,0x01,0x08,0x15,0x00,0xF8,0x00,0x00,0x60,0x00,0x00,0x94,0x80,0xD3,0x3F,0xAC}, 1e4 / 0.9 / 0x800000 },		// 30: 5 kOhm
{ DmmResistance4W,	5e4,	0x15,	{0xC2,0x21,0x14,0x83,0xA7,0x01,0x08,0x15,0x00,0xF8,0x00,0x00,0x00,0x06,0x00,0x94,0x80,0xD3,0x3F,0xAC}, 1e5 / 0.9 / 0x800000 },		// 31: 50 kOhm

{ DmmCapacitance,	5e-8,	0x15,	{0x72,0x21,0x14,0x8B,0x01,0x11,0x08,0x15,0x31,0xF8,0x00,0x00,0x00,0x08,0x00,0x9A,0x80,0xD7,0x33,0xA8}, 1e-5 },						// 32: 50nF (Read Mode I)
{ DmmCapacitance,	5e-7,	0x15,	{0x72,0x21,0x14,0x8B,0x01,0x11,0x08,0x15,0x31,0xF8,0x00,0x00,0x00,0x08,0x00,0x9A,0x80,0xD7,0x33,0xA8}, 1e-5 },						// 33: 500nF
{ DmmCapacitance,	5e-6,	0x15,	{0x72,0x21,0x14,0x8B,0x01,0x11,0x08,0x15,0x31,0xF8,0x00,0x00,0x00,0x08,0x00,0x9A,0x80,0xD7,0x33,0xA8}, 1e-5 },						// 34: 5uF
{ DmmCapacitance,	5e-5,	0x15,	{0x72,0x21,0x14,0x8B,0x01,0x11,0x08,0x15,0x31,0xF8,0x00,0x00,0x00,0x08,0x00,0x9A,0x80,0xD7,0x33,0xA8}, 1e-5 },						// 35: 50uF
{ DmmCapacitance,	5e-4,	0x15,	{0x72,0x21,0x14,0x8B,0x01,0x11,0x08,0x15,0x31,0xF8,0x00,0x00,0x00,0x08,0x00,0x9A,0x80,0xD7,0x33,0xA8}, 1e-5 },						// 36: 500uF
{ DmmCapacitance,	5e-3,	0x15,	{0xC0,0x21,0x07,0x93,0x85,0x11,0x08,0x15,0x55,0xF8,0x80,0x00,0x08,0x00,0x00,0x86,0x80,0xD1,0x33,0xAC}, 1e-5 },						// 37: 5mF (Read Mode II)
{ DmmCapacitance,	5e-2,	0x15,	{0x70,0xDE,0x07,0x93,0x85,0x11,0x08,0x15,0x55,0xF8,0x80,0x00,0x08,0x00,0x00,0x8F,0x80,0xDA,0x33,0xAC}, 1e-5 },						// 38: 50mF

{ DmmFrequency,		6e7,	0x05,	{0xCA,0xDE,0x07,0x93,0x85,0x11,0x08,0x15,0x55,0xF8,0x00,0x00,0x00,0x00,0x00,0x80,0x80,0xD7,0x33,0xAC}, 1e0 },						// 39: Frequency

{ DmmTemperature,	1e0,	0x11,	{0xC2,0xDE,0x14,0x8B,0x85,0x11,0x08,0x15,0x31,0xF8,0x00,0x00,0x00,0x00,0x08,0x81,0x80,0xC7,0x33,0xA8}, 125e-2 / 1.8 / 0x800000 },	// 40: Temperature

{ DmmContinuity,	5e2,	0x15,	{0x76,0x62,0x13,0x83,0x85,0x01,0x08,0x15,0x00,0xF8,0x00,0x40,0x06,0x00,0x00,0x94,0x80,0xD2,0x3F,0xAC}, 1e3 / 0.9 / 0x800000 },		// 41: Continuity

{ DmmDiode,			3e0,	0x15,	{0x12,0x62,0x13,0x8B,0x8D,0x11,0x08,0x15,0x11,0xF8,0x00,0x00,0x08,0x00,0x00,0x86,0x80,0xE2,0x33,0xAC}, 1e-6 / 1.08 }				// 42: Diode
};
...
uint8_t DMM_SetScale( int idxScale )
{
...
#if 1
	buf.r[0x17] = 0x60;
	DMM_SendCmdSPI( CS_DMM, 0x37, 1, &buf.r[0x17] );				// write R37=60h ???? This is done by DIGILENT
#endif
	DMM_GetCmdSPI( 0x20, 1, buf.r );							// read R20
	buf.r[0] = 0x48; DMM_SendCmdSPI( CS_DMM, 0x20, 1, buf.r );	// write R20 = 48h - SCMPI=010, ENCMP=1, ENCNTI,ENPCMPO,ENCTR=0
	...
	memcpy( buf.r, curCfg->cfg, sizeof(curCfg->cfg) );			// set registers R20..R33
	buf.ctsta = 0x40;
	buf.cta[2] = ( DMM_GetCurrentMode() == DmmFrequency ) ? 0xF0 : 0xBF;
	...
	DMM_SendCmdSPI( CS_DMM, 0x00, sizeof(buf), (uint8_t*)&buf );
...
double DMM_DGetStatus( uint8_t *pbErr )
{
	DMMSTS dmmsts; // registers 0x00 - 0x1D
	double v = NAN;
	uint8_t i;
	int64_t cnt;
	...
	if( DMM_FACScale( idxCurrentScale ) )					// AC uses RMS
	{
		...
		DMM_GetCmdSPI( 0x09, 5, (uint8_t*)&dmmsts.rms );

		for( i = 3; i < 4; --i )
			vrms = ( vrms << 8 ) | dmmsts.rms[i];
			 ...
			 idxCurrentScale <= SCALE_500_uF )
	{
		...
		// TODO - NOT WORKING !!!
		// ---
		for( cnt = 0, i = 3; i < 4; --i ) cnt = ( cnt << 8 ) | dmmsts.cta[i];
		v = curCfg->mul * cnt;
		...
		dmmsts.cta[1] = 0x00;
		dmmsts.cta[2] = 0xBF;
		DMM_SendCmdSPI( CS_DMM, 0x1B, 3, dmmsts.cta );		// write CTA=BF0000h (preset counter)
		i = 0x72; DMM_SendCmdSPI( CS_DMM, 0x20, 1, &i );	// write R20=72h - SCMPI=011, ENCMP=1, ENCNTI=0, ENPCMPO=0, ENCTR=1 (re-enable counters)

		// for dev debug
		for( cnt = 0, i = 3; i < 4; --i ) cnt = ( cnt << 8 ) | dmmsts.ctb[i];
		dMeasuredVal[1] = (double)cnt;

		for( cnt = 0, i = 3; i < 4; --i ) cnt = ( cnt << 8 ) | dmmsts.ctc[i];
			 ...
			 idxCurrentScale <= SCALE_50_mF )
	{
		...
		*/
		...
		DMM_GetCmdSPI( 0x20, 1, dmmsts.r );					// read R20
		...
		DMM_GetCmdSPI( 0x00, 3, (uint8_t*)&dmmsts );		// read AD1

		// AD1 is a 24-bit SIGNED value, so load it left justified and then divide by 256 to keep the sign
		int32_t vad1 = ( (int32_t)dmmsts.ad1[ 2 ] << 24 )
					 | ( (int32_t)dmmsts.ad1[ 1 ] << 16 )
					 | ( (int32_t)dmmsts.ad1[ 0 ] << 8 );
		vad1 /= 256;
	...
	else												// DC, RES, DIODE, CONT, TEMP use AD1
	{
		...
		DMM_GetCmdSPI( 0x00, 3, (uint8_t*)&dmmsts );
